...
int main(){
   ...
   fp = fopen("tarantula.txt", "w+");
	
	fprintf(fp,"\n\n\nTarantula Fault Localization\n");
	fprintf(fp,"\nThis file can be regenerated by typing 'make tarantula'\n");
		fprintf(fp,"\n\n\nSuspiciousness of lines in dominion.c");
	for(int i=0; i<newLineChars; i++){
		if(suspiciousnessArray[i]<10){fprintf(fp,"\n Line: %d   Suspiciousness: %f",i,suspiciousnessArray[i]);}
